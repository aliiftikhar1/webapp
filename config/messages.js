module.exports = {
    error: {
        ...
        WRONG_VERIFICATION_CODE: 'Email could not be verified, Please enter correct verification code!',
        INVALID_EMAIL_FOR_FORGET_PASSWORD: 'User does not exist,Please signup first',
        ...
        ExpiredAccessToken: {
            ...
            message:
                'Generate a new access token using your client credentials',
        },
